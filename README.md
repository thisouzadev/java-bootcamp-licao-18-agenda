...
Você faz parte da equipe desenvolvedora de uma startup e para um MVP você ficou responsável pelo desenvolvimento de um programa de uma agenda bastante simples (afinal, é um MVP!). Essa agenda de contatos deve por enquanto armazenar apenas nomes.

A classe deve se chamar Agenda, podendo ser instanciada, e deve definir os seguintes métodos:
...
Lembrando que desafio dado é desafio cumprido! Boa sorte! 😉
